...
<head>
  ...
  <title>Settings | CircuitXtract</title>
  ...
  <div class="container">
    <nav class="sidebar">
      <ul>
        ...
        <li><a href="/CircuitXtract/public/dashboard/settings.php" class="active"><i class="fas fa-cog"></i><span>Settings</span></a></li>
      ...
      <div class="grid">
        <div class="section">
          ...
          <ul style="list-style:none;padding:0;">
            <li><a href="#" style="color:#4EC5F1;">Change Password</a></li>
            <li><a href="#" style="color:#4EC5F1;">Manage Facilities</a></li>
            <li><a href="#" style="color:#4EC5F1;">Notification Preferences</a></li>
          </ul>
        </div>
        <div class="section">
          <h2>System Settings</h2>
          <ul style="list-style:none;padding:0;">
            <li><a href="#" style="color:#4EC5F1;">Data Export</a></li>
            <li><a href="#" style="color:#4EC5F1;">API Keys</a></li>
          </ul>
        </div>
      </div>
    </div>
