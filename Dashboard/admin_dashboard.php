...
// simple auth: redirect if no “user” cookie
...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; font-family:Arial,sans-serif; }
    ...
    /* Sidebar */
    .sidebar{width:200px; background:#111; display:flex; flex-direction:column;}
    .sidebar a{color:#ccc; padding:15px; text-decoration:none; border-bottom:1px solid #222;}
    .sidebar a:hover, .sidebar .active{background:#222; color:#fff;}
    /* Main */
    ...
    .overview-card{display:flex; align-items:center; gap:15px;}
    .overview-card i{font-size:1.8rem;color:#4EC5F1;}
    .overview-card h3{margin-bottom:5px;font-size:1rem;}
    .overview-card p{font-size:1.3rem;font-weight:bold;}
...
<body>
  ...
  <ul>
    ...
    <div class="main">
      ...
      <div class="grid">
        <!-- filepath: c:\xampp\htdocs\CircuitXtract\Dashboard\admin_dashboard.php -->
  ...
  $(function(){
    // 1) OVERVIEW
    $.getJSON('fetch_overview.php', data => {
    ...
    $.getJSON('fetch_metal_content.php', res => {
    ...
    $.getJSON('fetch_price_accumulation.php', res => {
    ...
    // 4) USER CONTRIBUTIONS
    $.getJSON('fetch_user_contributions.php', items => {
